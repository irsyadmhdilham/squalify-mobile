...
import { PointLogsComponent } from "../../../../components/point/point-logs/point-logs";
...
export class PointDetailPage {
  ...
  pk = this.navParams.get('point').pk;
  ...
  showLogs() {
    const modal = this.modalCtrl.create(PointLogsComponent, { pk: this.pk });
    modal.present();
  }
